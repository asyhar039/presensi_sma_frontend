...
const Modal = ({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: overlay click to close is intentional; keyboard handled via Escape listener
    <div
    ...
    >
      <div className="flex min-h-full items-center justify-center p-3 pt-[calc(env(safe-area-inset-top,0px)+0.75rem)] pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)]">
        {/* biome-ignore lint/a11y/useKeyWithClickEvents: inner stopPropagation prevents overlay close; no keyboard action needed */}
        {/* biome-ignore lint/a11y/noStaticElementInteractions: container for click stopPropagation */}
        <div
