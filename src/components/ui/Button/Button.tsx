...
const VARIANTS: Record<string, string> = {
  ...
  success:
    'border-success bg-success text-white hover:border-success-hover hover:bg-success-hover',
  danger:
    'border-danger bg-danger text-white hover:border-danger-hover hover:bg-danger-hover',
  warning:
    'border-warning bg-warning text-dark hover:border-warning-hover hover:bg-warning-hover',
  ...
  'outline-warning':
    'border-warning text-warning hover:bg-warning hover:text-dark',
