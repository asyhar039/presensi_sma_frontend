...
function Sortable<T>({
  ...
  const overlayContent = useMemo(() => {
    ...
    Children.forEach(children, (child) => {
      // biome-ignore-start lint/suspicious/noExplicitAny: This is a React component, so we can safely cast to any
      ...
      // biome-ignore-end lint/suspicious/noExplicitAny: This is a React component, so we can safely cast to any
    })
    return result
  }, [activeId, children])
